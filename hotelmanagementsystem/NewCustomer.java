	...
	NewCustomer(){
		...
		contentPane.add(lblReserveRoomNumber);
                ...
                try{
                    ...
                    ResultSet rs = c.smtStatement.executeQuery("select * from room_details where availability ='available' ");
                    while(rs.next()){
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
	    			...
	    			String s7 =  t5.getText();
                                ...
                                String q2 = "update room_details set availability = 'Unavailable' where rno= '"+s6+"'";
                                c.smtStatement.executeUpdate(q1);
